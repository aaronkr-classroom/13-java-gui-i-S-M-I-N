...
public class Ex14_02 {
	public static void main(String[] args) {
		...
		// 버튼 추가
		JButton btn1 = new JButton("Coke", new ImageIcon("img/cokeimage.png"));
		JButton btn2 = new JButton("DietCoke", new ImageIcon("img/DietCokeicon.png"));
		JButton btn3 = new JButton("Coke Zero", new ImageIcon("img/CokeZeroicon.png"));
		...
		JRadioButton rbtn4 = new JRadioButton("4학년",true);
		...
		panel.add(msg);
		JTextArea msgTxt = new JTextArea(5, 10); // 행 5개, 열 10개
		panel.add(msgTxt);
